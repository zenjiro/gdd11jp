...
public final class AStar extends Algorithm {
    ...
    void solvePuzzle(final long currentState, final int numOfThreads) {
        ...
        openMap = new HashMap<Integer, AStarNode>();
        closedMap = new HashMap<Integer, AStarNode>();
        ...
        while (running) {
            ...
            if (successor != null) {
                final int hashCode = successor.hashCode(),
                          cost = successor.cost;
                final AStarNode leftEl = closedMap.get(hashCode);
                if (leftEl == null) {
                    final AStarNode leftEl2 = openMap.get(hashCode);
                    if (leftEl2 == null) {
                        openHeap.insert(successor);
                        openMap.put(hashCode, successor);
                        ++numberExpanded;
            ...
            if (successor != null) {
                final int hashCode = successor.hashCode(),
                          cost = successor.cost;
                final AStarNode rightEl = closedMap.get(hashCode);
                if (rightEl == null) {
                    final AStarNode rightEl2 = openMap.get(hashCode);
                    if (rightEl2 == null) {
                        openHeap.insert(successor);
                        openMap.put(hashCode, successor);
                        ++numberExpanded;
            ...
            if (successor != null) {
                final int hashCode = successor.hashCode(),
                          cost = successor.cost;
                final AStarNode upEl = closedMap.get(hashCode);
                if (upEl == null) {
                    final AStarNode upEl2 = openMap.get(hashCode);
                    if (upEl2 == null) {
                        openHeap.insert(successor);
                        openMap.put(hashCode, successor);
                        ++numberExpanded;
            ...
            if (successor != null) {
                final int hashCode = successor.hashCode(),
                          cost = successor.cost;
                final AStarNode downEl = closedMap.get(hashCode);
                if (downEl == null) {
                    final AStarNode downEl2 = openMap.get(hashCode);
                    if (downEl2 == null) {
                        openHeap.insert(successor);
                        openMap.put(hashCode, successor);
                        ++numberExpanded;
            ...
            closedMap.put(currentConfig.hashCode(), currentConfig);
